...
export const OPENROUTER_GEMINI_EMBEDDING_2_PREVIEW = "openrouter/google/gemini-embedding-2-preview";
...
export function formatUnknownEmbeddingProviderError(
  ...
  const base = `Unknown embedding provider: ${provider}. No matching hardcoded or local provider found.`;
