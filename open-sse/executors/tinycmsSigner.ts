...
function generate_secure_payload(username, timestamp, nonce_js, challenge, client_ip, difficulty) {
  ...
  const ret = wasm.generate_secure_payload(
    ptr0,
    len0,
    ptr1,
    len1,
...
function __wbg_get_imports() {
  const import0 = {
    ...
    __wbg_fillText_b1722b6179692b85: function () {
    ...
    __wbg_toDataURL_bf99d85b39ce57cc: function () {
...
export function generateSecurePayload(
  ...
  return generate_secure_payload(
    username,
    timestamp,
    nonce_js,
    challenge,
